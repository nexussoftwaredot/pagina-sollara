      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-book-text font-semibold">
              Primeiras unidades a partir de R$ 299 mil e parcelas a partir de R$ 1.600,00 direto com a construtora.
            </p>
            <div className="w-32 h-1 bg-book-stone mx-auto my-6"></div>
            <p className="text-base md:text-lg text-book-text">
